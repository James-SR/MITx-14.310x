...
\includegraphics{Module3_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\includegraphics{Module3_files/figure-latex/unnamed-chunk-7-2.pdf}
...
\includegraphics{Module3_files/figure-latex/unnamed-chunk-7-3.pdf}
...
\includegraphics{Module3_files/figure-latex/unnamed-chunk-7-4.pdf}
...
\includegraphics{Module3_files/figure-latex/unnamed-chunk-8-1.pdf}
...
\includegraphics{Module3_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x,y) x}\OperatorTok{^}\DecValTok{2}\OperatorTok{*}\NormalTok{y}
\NormalTok{xmin <-}\StringTok{ }\OperatorTok{-}\DecValTok{1}\NormalTok{; xmax <-}\StringTok{ }\DecValTok{1}
\NormalTok{ymin <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) x}\OperatorTok{^}\DecValTok{2}\NormalTok{; ymax <-}\DecValTok{1}
\NormalTok{integral <-}\StringTok{ }\KeywordTok{integral2}\NormalTok{(f, xmin,xmax,ymin,ymax)}
\NormalTok{integral}\OperatorTok{$}\NormalTok{Q }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{integral}\OperatorTok{$}\NormalTok{Q }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{fractions}\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{integral}\OperatorTok{$}\NormalTok{Q )}
\end{Highlighting}
\end{Shaded}
...
\[∫_{1}^{0}∫_{x^2}^{x}5.25x^2ydydx = \frac{3}{20}\] We can now calculate
this as before

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x,y,c) c }\OperatorTok{*}\StringTok{ }\NormalTok{x}\OperatorTok{^}\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{y}
\NormalTok{c <-}\StringTok{ }\FloatTok{5.25}
\NormalTok{xmin <-}\StringTok{ }\DecValTok{1}\NormalTok{; xmax <-}\StringTok{ }\DecValTok{0}
\NormalTok{ymin <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) x}\OperatorTok{^}\DecValTok{2}\NormalTok{; ymax <-}\ControlFlowTok{function}\NormalTok{ (x) x}
\NormalTok{I<-}\StringTok{ }\KeywordTok{integral2}\NormalTok{(f, xmin,xmax,ymin,ymax, }\DataTypeTok{c =}\NormalTok{ c) }
\NormalTok{I}\OperatorTok{$}\NormalTok{Q }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{I}\OperatorTok{$}\NormalTok{Q}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{fractions}\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{I}\OperatorTok{$}\NormalTok{Q) }\CommentTok{# as a fraction}
\end{Highlighting}
\end{Shaded}
...
\subsection{Marginal or Individual
Distributions}\label{marginal-or-individual-distributions}
